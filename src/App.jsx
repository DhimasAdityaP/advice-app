...
params: { query: 'sea,mountain,forest', client_id:
...
>
<div className="bg-gray-500 p-10 rounded-lg shadowmd max-w-md w-full bg-clip-padding backdrop-filter
backdrop-blur-sm bg-opacity-10 border border-gray-100">
<h1 className="text-xl font-light font-mono mb-4
text-center">"{advice || "Click the button to get advice"}"</h1>
<button
